...
export default function ProcessCard({
  ...
  return (
    ...
    >
      <motion.div
        className="relative w-full mx-3 sm:mx-4 md:mx-12 lg:mx-20 overflow-hidden"
        style={{
      ...
      >
        ...
        <div className="h-full grid grid-cols-1 md:grid-cols-2 [grid-template-rows:3fr_2fr] md:[grid-template-rows:none]">

          {/* Left — text content */}
          <div
            className="flex flex-col justify-between p-6 sm:p-8 md:p-12 lg:p-14"
          ...
          >
            ...
            <div className="flex items-start justify-between">
              ...
              <span
                ...
                style={{ color: textColor, opacity: 0.45, fontWeight: 400 }}
              >
                {index} / 04
              </span>
            </div>
            ...
            <div className="flex flex-col gap-4 sm:gap-6">
              ...
              />
              <p
                className="font-sans text-sm sm:text-base md:text-[17px] italic leading-relaxed"
                style={{ color: textColor, opacity: 0.78, fontWeight: 400, maxWidth: '34ch' }}
              >
                {description}
              </p>
            </div>
